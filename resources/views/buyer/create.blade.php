    ...
    <div class="container mx-auto p-6 bg-white shadow-md rounded-md mt-10 max-w-md">
        ...
        <form action="{{ route('buyer.store') }}" method="POST">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('buyer.index') }}" class="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600 focus:outline-none focus:bg-yellow-700 shadow-md">Kembali</a>
            </div>
